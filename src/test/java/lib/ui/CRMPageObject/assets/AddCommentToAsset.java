...
public class AddCommentToAsset extends MainPageObject {
    ...
    public AddCommentToAsset(WebDriver driver)
    {
        super(driver);
    }

    public void addCommentToAssetMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        this.waitForElementsPresent(
                ...
                "can't find list of subtabs on a specific asset page",
                5
        );
        ...
        Assert.assertEquals("Incorrect number of subtabs on a specific asset page", 2, amount_of_elements);
