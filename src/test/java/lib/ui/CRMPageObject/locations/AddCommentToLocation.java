...
public class AddCommentToLocation extends MainPageObject {
    ...
    public AddCommentToLocation(WebDriver driver)
    {
        super(driver);
    }

    public void addCommentToLocationMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        this.waitForElementsPresent(
                ...
                "can't find list of subtabs on a specific location page",
                5
        );
        ...
        Assert.assertEquals("Incorrect number of subtabs on a specific location page", 2, amount_of_elements);
