...
public class AddCommentToContact extends MainPageObject {
    ...
    public AddCommentToContact(WebDriver driver)
    {
        super(driver);
    }

    public void addCommentToContactMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        this.waitForElementsPresent(
                ...
                "can't find list of subtabs on a specific contact page",
                5
        );
        ...
        Assert.assertEquals("Incorrect number of subtabs on a specific contact page", 2, amount_of_elements);
