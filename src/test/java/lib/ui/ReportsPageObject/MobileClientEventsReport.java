...
public class MobileClientEventsReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='user_device_action']",
    ...
    USER_NAME_IS_PRESENT = "(//span[text()='andrew'])[1]";

    public MobileClientEventsReport(WebDriver driver)
    {
        super(driver);
    }

    public void mobileClientEventsReportMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Assert.assertEquals("Incorrect number of columns", 19, amount_of_elements);

        Thread.sleep(2000);
        this.assertElementHasText(
                By.xpath(USER_NAME_IS_PRESENT),
                "andrew",
                "can't find 'andrew' user"
        );
    }
}
