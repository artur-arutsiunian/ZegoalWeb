...
public class SummaryTimesheetReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='summary_timesheet']",
    ...
    public SummaryTimesheetReport(WebDriver driver)
    {
        super(driver);
    }

    public void summaryTimesheetReportMethod() throws InterruptedException {
            Thread.sleep(2000);
            ...
            Assert.assertEquals("Incorrect number of columns", 14, amount_of_elements);
