...
public class CustomReport extends MainPageObject {
    ...
    USER_EMAIL_IS_PRESENT = "(//span[text()='newemail@mail.ru'])[1]";

    public CustomReport(WebDriver driver)
    {
        super(driver);
    }

    public void customReportMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        this.assertElementHasText(
                By.xpath(USER_EMAIL_IS_PRESENT),
                "newemail@mail.ru",
                "can't find 'newemail@mail.ru' user email"
        );
    }
}
