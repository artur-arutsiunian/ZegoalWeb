...
public class MovementReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='movement']",
    ...
    public MovementReport(WebDriver driver)
    {
        super(driver);
    }

    public void movementsReportMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Assert.assertEquals("Incorrect number of columns", 10, amount_of_elements);
