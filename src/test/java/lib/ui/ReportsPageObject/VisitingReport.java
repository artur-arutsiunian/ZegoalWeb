...
public class VisitingReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='visiting']",
    ...
    public VisitingReport(WebDriver driver)
    {
        super(driver);
    }

    public void visitingReportMethod() throws InterruptedException {
        Thread.sleep(2000);
