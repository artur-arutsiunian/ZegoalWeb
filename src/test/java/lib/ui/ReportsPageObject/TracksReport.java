...
public class TracksReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='tracks']",
    ...
    LIST_OF_COLUMNS_IS_PRESENT = "//div[@class='react-grid-HeaderCell']",
    USER_IS_PRESENT = "(//div[text()='andrew andrew'])[1]";

    public TracksReport(WebDriver driver)
    {
        super(driver);
    }

    public void tracksReportMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Assert.assertEquals("Incorrect number of columns", 5, amount_of_elements);
