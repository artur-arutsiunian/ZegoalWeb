...
public class EventsTimesheetReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='events_timesheet']",
    ...
    public EventsTimesheetReport(WebDriver driver)
    {
        super(driver);
    }

    public void eventsTimesheetReportMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Assert.assertEquals("Incorrect number of columns", 7, amount_of_elements);
