...
public class TaskReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='main_task']",
    ...
    public TaskReport(WebDriver driver)
    {
        super(driver);
    }

    public void taskReportMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Assert.assertEquals("Incorrect number of columns", 21, amount_of_elements);
