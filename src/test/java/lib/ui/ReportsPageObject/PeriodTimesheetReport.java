...
public class PeriodTimesheetReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='period_timesheet']",
    ...
    public  PeriodTimesheetReport(WebDriver driver)
    {
        super(driver);
    }

    public void periodTimesheetReportMethod() throws InterruptedException {
        Thread.sleep(2000);
        ...
        Assert.assertEquals("Incorrect number of columns", 11, amount_of_elements);
