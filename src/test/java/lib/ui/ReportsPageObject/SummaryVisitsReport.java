...
public class SummaryVisitsReport extends MainPageObject {
    ...
    CHOOSE_TYPE = "//li[@data-value='summary_visiting']",
    ...
    public SummaryVisitsReport(WebDriver driver)
    {
        super(driver);
    }

    public void summaryVisitsReportMethod() throws InterruptedException {
        Thread.sleep(2000);
